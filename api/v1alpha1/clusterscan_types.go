...
import (
	batchv1 "k8s.io/api/batch/v1" // Import the batch API package
...
type ClusterScanSpec struct {
	...
	// Schedule is a cron expression to specify the schedule of the scan
	Schedule string `json:"schedule,omitempty"`

	// JobTemplate defines the job to be created for the scan
...
type ClusterScanStatus struct {
	...
	// LastScanTime is the last time the scan was run
	LastScanTime *metav1.Time `json:"lastScanTime,omitempty"`

	// LastScanResult is the result of the last scan
